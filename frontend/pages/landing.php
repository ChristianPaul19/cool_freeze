...
<body>
    <div class="navmenu">
        <ul>
            ...
            <li class="primarybtn"><a href="login.php">Book Service</a><img src="frontend/assets/img/right.svg" alt="profiles"></li>
        </ul>
    </div>
    <section id="hero">
        <div class="herocontainer">
            ...
            <div class="btncontainer">
                ...
                <div class="secondarybtn"><a href="#whychooseus">Explore</a><img src="frontend/assets/img/down.svg" alt="profiles"></div>
            </div>
        ...
        <div class="serviceautoscroll">
            <div class="serviceautoscrollcontent">
                <img src="frontend/assets/img/4star.svg" alt="profiles">
                <p>AC Repair</p>
                <img src="frontend/assets/img/4star.svg" alt="profiles">
                <p>AC Installation</p>
                <img src="frontend/assets/img/4star.svg" alt="profiles">
